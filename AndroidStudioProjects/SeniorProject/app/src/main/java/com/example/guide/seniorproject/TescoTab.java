...
public class TescoTab extends Fragment {
    ...
    public static List<DataProduct> data;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mRVProduct = (RecyclerView) view.findViewById(R.id.productPriceList1);
        context = getActivity();
        ...
        public void onPostExecute(String result) {
            ...
            if(result.equals("no rows")) {
                ...
                try {
                    ...
                    mAdapter = new AdapterProduct(context, data);
                    mRVProduct.setAdapter(mAdapter);
                    mRVProduct.setLayoutManager(new LinearLayoutManager(context));
    ...
    public static ArrayList<DataProduct> getSelectedItems() {
        ArrayList<DataProduct> selectedItems = new ArrayList<>();
        for( DataProduct item : data ) {
            if( item.isSelected() )
